  ...
  return (
    <div id="menu-nav" className="sticky z-40 bg-background border-b border-border shadow-sm" style={{ top: "calc(var(--navbar-height, 53px) - 1px)" }}>
      <div
        ...
        className="menu-categories flex items-center overflow-x-auto gap-0.5 md:gap-1 py-[7px] md:py-[13px] px-2 md:px-6 scroll-smooth min-h-0"
      >
        {categories.map((item) => (
          <button
            key={item.id}
            ...
            className={`whitespace-nowrap px-2 md:px-3 py-[5px] md:py-[7px] text-[11px] md:text-sm tracking-[0.08em] md:tracking-[0.1em] font-body font-medium transition-all flex-shrink-0 rounded-sm leading-tight
